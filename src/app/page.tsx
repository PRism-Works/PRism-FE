  ...
  return (
    <div
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <Oval className="absolute left-1/2 top-[-20px] h-auto w-full -translate-x-1/2 transform md:top-[-4%]" />
      </div>
      <div className="relative z-10 flex-col-center md:mt-20 md:space-y-16">
        <Title
          className="w-full max-w-[945px] sm:max-w-[520px] md:max-w-[620px] lg:max-w-[800px] xl:max-w-[945px]"
