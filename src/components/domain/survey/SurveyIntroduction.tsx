...
export default function SurveyIntroduction({ setShowIntroduction }: SurveyIntroductionProps) {
  ...
  return (
    <div className="container min-h-screen w-full max-w-[1040px] px-4 py-8 text-gray-700 flex-col-center md:px-8">
      ...
      <p className="mb-2 text-center text-base text-gray-500 mobile1">
        공들인 프로젝트의 마지막 여정을 PRism과 함께해주셔서 감사합니다.
      </p>
      <div className="mb-12 flex-col-center">
        <div className="mb-2 mt-4 flex-center">
          <AlarmClock className="mr-2 h-5 w-5 text-gray-600" />
      ...
      <div className="w-full md:w-[80%] lg:w-[70%] xl:w-[65%]">
        <div className="mb-8 w-full">
          <h2 className="mb-4 text-black display6">✨ PRism 서비스 소개 ✨</h2>
          <div className="mb-8">
            <div className="mb-2 flex text-gray-600 display6">
              <span className="mr-3 text-gray-700">Q. </span>
              PRism은 어떤 서비스인가요?
            </div>
            <div className="mb-2 flex text-purple-700 mobile1">
              <span className="mr-3 text-gray-700">A. </span>팀 프로젝트는 개인의 커뮤니케이션
              능력을 신뢰도 있게 파악할 수 있는 좋은 기회입니다.
            </div>
            <div className="ml-8 whitespace-pre-wrap text-gray-600 display5">
          ...
          <div className="mb-4">
            <div className="mb-8">
              ...
              <div className="mb-2 flex text-purple-700 mobile1">
                <span className="mr-3 text-gray-700">A. </span>
        ...
        <div className="mb-8 w-full text-center">
          <h2 className="mb-4 text-left text-black display6">
            📍 평가를 진행하기 전 아래 내용을 확인해 주세요
          </h2>
          <div className="mb-8 text-left">
            <p className="mb-2 text-black">개인정보 처리 방침 요약</p>
          ...
          <div className="mb-8 text-left">
            <p className="mb-2 text-black">이용약관 요약</p>
            <div className="display5">
              <ul className="ml-4 list-inside list-disc text-gray-600">
                <li className="mb-1">
      ...
      <p className="my-2 text-purple-700 display6">
